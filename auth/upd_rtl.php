<?php
    ...
    $latarbelakang = mysqli_real_escape_string($con, $_POST['viewlatarblkg']);
    $manfaat = mysqli_real_escape_string($con, $_POST['viewmanfaat']);
    $milestone = mysqli_real_escape_string($con, $_POST['viewmilestone']);
   ...
   // Mencegah MySQL injection
    ...
    $update_inovasi = "UPDATE rtl SET ruanglingkup = '".$ruanglingkup__."', cluster = '".$cluster__."', judul = '".$judul__."', latarbelakang = '".$latarbelakang."', manfaat = '".$manfaat."', milestone = '".$milestone."' WHERE id_rtl = '".$id__."';";
