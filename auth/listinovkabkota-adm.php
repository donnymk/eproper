<?php
    ...
    //jika data ditemukan
        ...
        while($baris=mysqli_fetch_array($selectinovasi)){
            ...
            <td>
                <a class="tautan" href="inovasi.php?id='.$baris['id'].'">'.strtoupper($baris['judul']).'</a>
            </td>
            <td>'.$baris['namadiklat'].'</td>
            <td>'.$baris['nama'].'</td>
            <td>'.$baris['asal_peserta'].'<br>('.$baris['pemda'].')</td>
            <td><small>'.$baris['tglsubmit'].'</small><br>'.$status.'</td>
            <td>'.$btnveri
                    . '<a href="editinovasi.php?id='.$baris['id'].'" title="edit">'
                    . '<span class="glyphicon glyphicon-edit"></span>'
                    . '</a>'
                    . '<a onclick="return confirmdel()" href="delinovasi.php?id='.$baris['id'].'&tipe=kabkota" title="hapus">
