...
<html>
    ...
    <body>
        <div class="container">
           ...
           <br>
           <small><a class="tautan" href="dinovasi.php">Direktori inovasi</a></small> » <small id="navjudul"></small><small id="btn-edit"></small>
            <br><br>
            ...
            $.ajax({
                ...
                success: function(a){
                    ...
                    if(a[0].nip==session_nip){
                            $('#btn-edit').html(' <a href="editinovasi.php?id='+id+'" class="w3-btn w3-sm w3-deep-orange">Edit</a>');
                    }
