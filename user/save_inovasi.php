 ...
 ob_start();
    ...
    $insertinovasi = "INSERT INTO inovasi (`nip`, `namadiklat`, `jenisdiklat`, `tahun`, `kelompok`, `jenis_inovasi`, `judul`, `latarbelakang`, `manfaat`, `milestone`, `status`, `tglsubmit`, `asal_peserta`) VALUES('$nip__', '$namadiklat__', '$jenisdiklat__', '$tahun__', '$kelompok__', '$jenisinovasi__', '$judul__', '$latarbelakang__', '$manfaat__', '$milestone__', '0', now(), 'internal')";
    ...
    if($eksekusi){
        //header("Location: success.php?nip=".$nip."&namadiklat=".$namadiklat);
    ?>
    <script>window.location = "success.php?nip=<?= $nip ?>&namadiklat=<?= $namadiklat ?>"</script>
    <?php
