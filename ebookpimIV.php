                    ...
                    <ul class="w3-navbar w3-teal w3-round">
                        ...
                        <li class="w3-dropdown-click">
                            ...
                            <div id="menu0" class="w3-dropdown-content w3-white w3-card-4 w3-padding" style="z-index: 1">
                                ...
                                <a href="ebookpimIV.php" class="w3-blue-grey">Direktori Inovasi Diklatpim Tingkat IV</a>                    
                            </div>                            
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                                <h3>Buku Inovasi Diklat Kepemimpinan Tingkat IV</h3>
                                <embed src="doc/Direktori-Pim-IV.pdf" type="application/pdf" style="width: 100%; height: 600px">
                        </div>      
                    </div>                    
                </div>
            </div>       
