<?php
    ...
    $update_inovasi = "UPDATE rtl SET ruanglingkup = '".$ruanglingkup."', cluster = '".$cluster."', judul = '".$judul."', latarbelakang = '".$latarbelakang__."', manfaat = '".$manfaat__."', milestone = '".$milestone__."' WHERE id_rtl = '".$id__."';";
