...
for ($i=2; $i<=$hasildata; $i++){
    ...
    $query = "INSERT INTO user(`user`,`password`,`nama`,`nip`,`jabatan`,`skpd`,`namadiklat`,`jenisdiklat`,`tipe`) VALUES ('".$data1."','".enkrip($data2)."','".$data3."','".$data4."','".$data5."','".$data6."','".$namadiklat."','".$jenisdiklat."','kabkota')";
...
echo "<a href='lihatuser1.php'>Lihat user</a>";
?>
