        ...
        <div class="container-fluid">           
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div>
                        <h3 style="float: left"><b>Direktori Inovasi Diklat Kepemimpinan</b></h3>
                        <h4 style="float: right">BADAN PENGEMBANGAN SUMBER DAYA MANUSIA DAERAH</h4>
                    </div>                    
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <ul class="w3-navbar w3-blue w3-round">
            ...
            <div style="max-width: 800px; margin: auto">
                <h3>Tambah User Peserta Internal</h3>
